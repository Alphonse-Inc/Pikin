    ...
    <div class="container">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="feature-box">
                    ...
                    <div class="text-purple-light">SUCCESS</div>
                    <div class="text-purple-dark">You have successfully booked an educator with Pikin.</div>
                    <a href="#" class="ybtn ybtn-pink ybtn-shadow">View your account page</a>
                </div>
            </div>
        </div>
    </div>
